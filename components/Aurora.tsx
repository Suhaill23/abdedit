...
export default function Aurora(props: AuroraProps) {
    ...
    useEffect(() => {
        colorStopsRef.current = colorStops.map(hex => {
            const c = new Color(hex);
            return [c.r, c.g, c.b];
        });
    }, [colorStops]);
    ...
    useEffect(() => {
        ...
        // 🔥 التعديل الأهم هنا لتحسين الأداء
        const renderer = new Renderer({
            alpha: true,
            premultipliedAlpha: true,
            antialias: true,
            // هذا السطر يجبر المتصفح على استخدام دقة عادية حتى لو الشاشة 4K
            // هذا يخفف الضغط على المعالج بنسبة 70%
